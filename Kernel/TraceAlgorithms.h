...
CTL_EXPORT CUDA_HOST CUDA_DEVICE Spectrum UniformSampleAllLights(const BSDFSamplingRecord& bRec, const Material& mat, int nSamples, CudaRNG& rng, bool attenuated = false);

CTL_EXPORT CUDA_HOST CUDA_DEVICE Spectrum UniformSampleOneLight(const BSDFSamplingRecord& bRec, const Material& mat, CudaRNG& rng, bool attenuated = false);
