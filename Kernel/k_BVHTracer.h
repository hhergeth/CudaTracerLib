...
#endif
template<typename CLB> CUDA_FUNC_IN bool k_TraceRayTemplate(const Ray& r, float& rayT, const CLB& clb, e_BVHNodeData* hosthNodes, e_BVHNodeData* deviceNodes, int bvhNodesOffset = 0, int startNode = 0)
{
#ifdef ISCUDA
