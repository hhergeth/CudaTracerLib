...
#define INTERP(w, i) \
        lerp(vals[i], vals[(i)+1], ((w) - lambda[i]) / (lambda[(i)+1] - lambda[i]))
...
void SpectrumHelper::staticData::init()
{
	...
	for (int i = 0; i < SPECTRUM_SAMPLES; ++i)
	{
		float wl0 = lerp(SPECTRUM_MIN_WAVELENGTH, SPECTRUM_MAX_WAVELENGTH, float(i) / float(SPECTRUM_SAMPLES));
		float wl1 = lerp(SPECTRUM_MIN_WAVELENGTH, SPECTRUM_MAX_WAVELENGTH, float(i+1) / float(SPECTRUM_SAMPLES));
		CIE_X[i] = AverageSpectrumSamples(CIE_lambda, ::CIE_X, nCIESamples, wl0, wl1);
		CIE_Y[i] = AverageSpectrumSamples(CIE_lambda, ::CIE_Y, nCIESamples, wl0, wl1);
		CIE_Z[i] = AverageSpectrumSamples(CIE_lambda, ::CIE_Z, nCIESamples, wl0, wl1);
	}
	...
	for (int i = 0; i < SPECTRUM_SAMPLES; ++i)
	{
		float wl0 = lerp(SPECTRUM_MIN_WAVELENGTH, SPECTRUM_MAX_WAVELENGTH, float(i) / float(SPECTRUM_SAMPLES));
		float wl1 = lerp(SPECTRUM_MIN_WAVELENGTH, SPECTRUM_MAX_WAVELENGTH, float(i+1) / float(SPECTRUM_SAMPLES));
		rgbRefl2SpecWhite[i] = AverageSpectrumSamples(RGB2SpectLambda, RGBRefl2SpectWhite, nRGB2SpectSamples, wl0, wl1);
		rgbRefl2SpecCyan[i] = AverageSpectrumSamples(RGB2SpectLambda, RGBRefl2SpectCyan, nRGB2SpectSamples, wl0, wl1);
		rgbRefl2SpecMagenta[i] = AverageSpectrumSamples(RGB2SpectLambda, RGBRefl2SpectMagenta, nRGB2SpectSamples, wl0, wl1);
		rgbRefl2SpecYellow[i] = AverageSpectrumSamples(RGB2SpectLambda, RGBRefl2SpectYellow, nRGB2SpectSamples, wl0, wl1);
		rgbRefl2SpecRed[i] = AverageSpectrumSamples(RGB2SpectLambda, RGBRefl2SpectRed, nRGB2SpectSamples, wl0, wl1);
		rgbRefl2SpecGreen[i] = AverageSpectrumSamples(RGB2SpectLambda, RGBRefl2SpectGreen, nRGB2SpectSamples, wl0, wl1);
		rgbRefl2SpecBlue[i] = AverageSpectrumSamples(RGB2SpectLambda, RGBRefl2SpectBlue, nRGB2SpectSamples, wl0, wl1);
        
		rgbIllum2SpecWhite[i] = AverageSpectrumSamples(RGB2SpectLambda, RGBIllum2SpectWhite, nRGB2SpectSamples, wl0, wl1);
		rgbIllum2SpecCyan[i] = AverageSpectrumSamples(RGB2SpectLambda, RGBIllum2SpectCyan, nRGB2SpectSamples, wl0, wl1);
		rgbIllum2SpecMagenta[i] = AverageSpectrumSamples(RGB2SpectLambda, RGBIllum2SpectMagenta, nRGB2SpectSamples, wl0, wl1);
		rgbIllum2SpecYellow[i] = AverageSpectrumSamples(RGB2SpectLambda, RGBIllum2SpectYellow, nRGB2SpectSamples, wl0, wl1);
		rgbIllum2SpecRed[i] = AverageSpectrumSamples(RGB2SpectLambda, RGBIllum2SpectRed, nRGB2SpectSamples, wl0, wl1);
		rgbIllum2SpecGreen[i] = AverageSpectrumSamples(RGB2SpectLambda, RGBIllum2SpectGreen, nRGB2SpectSamples, wl0, wl1);
		rgbIllum2SpecBlue[i] = AverageSpectrumSamples(RGB2SpectLambda, RGBIllum2SpectBlue, nRGB2SpectSamples, wl0, wl1);
	}
